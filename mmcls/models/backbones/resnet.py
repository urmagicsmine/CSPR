...
class ResNet(BaseBackbone):
    ...
    def __init__(self,
        ...
        # Added by lzh
        conv1_stride = 2 if self.stem_stride else 1
        self._make_stem_layer(in_channels, stem_channels, conv1_stride)
    ...
    def _make_stem_layer(self, in_channels, stem_channels, conv1_stride):
        if self.deep_stem:
