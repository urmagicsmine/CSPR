...
class ImageToTensor(object):
    ...
    def __repr__(self):
        return self.__class__.__name__ + f'(keys={self.keys}, is_3d_input={self.is_3d_input})'
...
class DefaultFormatBundle(object):
    ...
    """
    def __init__(self, is_3d_input = False, med_view=False):
        self.is_3d_input = is_3d_input
    ...
    def __call__(self, results):
        ...
        if 'img' in results:
            ...
            if self.is_3d_input: 
                img = img[None,...] # unsqueeze dim-0 for 3d input
        ...
        if 'gt_label' in results:
            ...
            results['gt_label'] = to_tensor(gt_label)
...
class Collect(object):
    ...
    def __init__(self,
                 ...
                 meta_keys=('filename', 'ori_filename', 'ori_shape',
                            ...
                            'flip_direction', 'img_norm_cfg', 'zflip',
                            'target_slice_spacing')):
        self.keys = keys
