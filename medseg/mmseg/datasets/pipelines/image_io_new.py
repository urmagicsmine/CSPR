...
def load_multislice_gray_png_new(imname, min_idx, max_idx, num_slice=3, zflip=False):
    ...
    # im_cur = cv2.resize(im_cur, (224, 224), interpolation=cv2.INTER_LINEAR)
