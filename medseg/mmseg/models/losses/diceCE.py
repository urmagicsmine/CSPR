...
class DiceCELoss(_Loss):
    ...
    def forward(self,
        ...
        """
        # for medseg, target is (n, c, h, w). Convert to one hot style :(n, num_class, h, w)
        target = one_hot(target[:, None, ...], num_classes=input.shape[1] )
        ...
        #print('dice and ce are:', dice_loss, ce_loss)
