...
model = dict(
    ...
    is_3d_pred=True,
    converter='I3D',
    pretrained='/lung_general_data/pretrained_model/med2d_resnet/resnet18-5c106cde_med1channel.pth',
    #pretrained='/mnt/LungGeneralDataNFS/pretrained_model/med2d_resnet/resnet18-5c106cde_med1channel.pth',
    backbone=dict(
        type='ResNet3D',
        depth=18,
        num_stages=4,
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        num_slices=32,
        split='liver_norm1_all_dir_pa_range.txt', # pa=210=2*105 pa500=1000 epochs
