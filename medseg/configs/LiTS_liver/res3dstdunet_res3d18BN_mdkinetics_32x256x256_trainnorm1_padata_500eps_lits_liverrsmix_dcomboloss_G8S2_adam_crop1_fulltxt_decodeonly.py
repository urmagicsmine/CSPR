...
model = dict(
    type='EncoderDecoder',
    is_3d_pred=True,
    pretrained='/lung_general_data/pretrained_model/kinetics/r3d18_KM_200ep_med1channel.pth',
    #pretrained='/mnt/LungGeneralDataNFS/pretrained_model/kinetics/resnet-18-kinetics_med1channel.pth',
    backbone=dict(
        type='ResNet3D',
        depth=18,
        num_stages=4,
