...
model = dict(
    type='EncoderDecoder',
    is_3d_pred=True,
    #pretrained='pretrained_model/resnet-18-kinetics.pth',
    pretrained='pretrained_model/kinetics/r3d18_KM_200ep_med1channel.pth',
    backbone=dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(
            ...
            type='CombineLoss', use_sigmoid=False, loss_weight=(0.5, 1.0))))
...
save_times = 10
sample_per_gpu = 4
data = dict(samples_per_gpu=sample_per_gpu)
