...
train_pipeline = [
    dict(type='LoadVolumeFromFile', window_width=1600, window_center=-600, ct_type='nii'),
...
test_pipeline = [
    dict(type='LoadVolumeFromFile', window_width=1600, window_center=-600),
    dict(
