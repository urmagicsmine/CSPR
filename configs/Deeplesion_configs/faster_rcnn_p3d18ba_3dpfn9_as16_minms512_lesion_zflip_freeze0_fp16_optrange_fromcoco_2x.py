...
model = dict(
    type='FasterRCNN',
    pretrained='pretrained_model/mp3d/mp3d18ba_ms640_34.3-62f7bd57.pth',
    backbone=dict(
        type='P3D',
        depth='18ba',
        ST_struc=('A','B','C'),
...
train_pipeline = [
    dict(type='LoadImageFromFile_3DCE', to_float32=False, lesion_input=True, num_slice=NUM_SLICE, zflip=True),
...
test_pipeline = [
    dict(type='LoadImageFromFile_3DCE', to_float32=False, lesion_input=True, num_slice=NUM_SLICE, zflip=False),
    dict(
...
log_level = 'INFO'
work_dir = './work_dirs/mia_deeplesion/faster_rcnn_p3d18ba_3dpfn9_as16_minms512_lesion_zflip_freeze0_fp16_optrange_fromcoco_2x'
load_from = None
resume_from = None
workflow = [('train', 1)]
